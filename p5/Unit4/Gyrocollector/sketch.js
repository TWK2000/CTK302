...
//   textSize(40);
//   textAlign(CENTER);
//   text("Starburst Candy", width / 2, 600, windowWidth - 200, windowHeight - 200);
//
//
...
//     rect(this.pos.x - 50, this.pos.y, 50, 50);
//     rect(this.pos.x + 50, this.pos.y, 50, 50);
//     // ellipse(this.pos.x + 17, this.pos.y - 30, 80, 60) ;
//
//   }
//
//   this.drive = function() {
...
function setup() {
  ...
  // load any images you need
  //bunnyImage = loadImage("assets/bunny.jpg");
  bunnyImage = loadImage("assets/teeth.gif");
  imageMode(CENTER);
  rectMode(CENTER);
  noStroke();
}
